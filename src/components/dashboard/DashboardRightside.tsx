...
function Engagement() {
  return (
    <div className="border border-[#F0F0F0] rounded-lg p-3 my-2">
      ...
      <button className="flex w-full items-center justify-center gap-2 pointer-events-none p-2 rounded-md bg-[#E9F3F9] text-[#2E6B8A] font-medium text-sm hover:cursor-pointer">
