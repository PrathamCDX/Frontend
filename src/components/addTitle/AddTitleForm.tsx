  ...
  return (
    <div className="fixed z-50 w-full h-full font-inter flex items-center justify-center bg-[#0F172A]/20 backdrop-blur-[10px] ">
      <div className="flex flex-col w-full sm:w-1/2 h-full sm:h-1/2  bg-white sm:rounded-[28px] relative overflow-hidden bg-[radial-gradient(120%_120%_at_50%_10%,rgba(255,255,255,0)_64%,rgba(178,214,244,0.55)_80%,rgba(164,206,241,0.70)_94%,rgba(152,198,236,0.84)_100%)] shadow-2xl">
        ...
        <div className="w-full flex-1 my-5 flex items-center h-full">
          <div className="w-full h-full">
            <FormProvider {...methods}>
              <div className="flex flex-col gap-2 h-full items-center justify-center w-full px-3 sm:px-6">
                <div className="flex-1 flex flex-col sm:justify-center w-full mb-2">
                ...
                <button
                  ...
                  className={`w-full sm:w-1/2  text-center flex items-center justify-center gap-x-2 rounded-2xl px-8 py-3 text-xl font-medium text-white transition ${
                    jobTitleExists
